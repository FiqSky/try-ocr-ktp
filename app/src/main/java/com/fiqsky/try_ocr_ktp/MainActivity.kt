package com.fiqsky.try_ocr_ktp
...
import com.fiqsky.try_ocr_ktp.databinding.ActivityMainBinding
    ...
    private fun startCamera() {
        ...
        cameraProviderFuture.addListener({
            ...
            val viewPort = if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.R) {
                ...
                ViewPort.Builder(Rational(width, height), Surface.ROTATION_0).build()
            }
